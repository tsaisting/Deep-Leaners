...
#drop <- c('original_title','date_published','worlwide_gross_income','metascore','reviews_from_critics','production_company','description','writer')
...
movie_ratings <- movie_ratings[which(startsWith(movie_ratings$budget, "$") =='TRUE'),]
movie_ratings$budget <- as.numeric(gsub('[$,]', '', movie_ratings$budget))
movie_ratings <- movie_ratings[which(startsWith(movie_ratings$worlwide_gross_income, "$") =='TRUE'),]
movie_ratings$worlwide_gross_income <- as.numeric(gsub('[$,]', '', movie_ratings$worlwide_gross_income))


movie_ratings$avg_vote[movie_ratings$avg_vote < median(movie_ratings$avg_vote)] = 0
movie_ratings$avg_vote[movie_ratings$avg_vote >= median(movie_ratings$avg_vote)] = 1

movie_ratings$year <- as.numeric(movie_ratings$year)
movie_ratings$year[movie_ratings$year <= 1950] = 0
movie_ratings$year[movie_ratings$year > 1950 & movie_ratings$year < 2000] = 1
movie_ratings$year[movie_ratings$year >= 2000] = 2

str(movie_ratings)

#movie_ratings$genre <- as.factor(movie_ratings$genre)
#movie_ratings$country <- as.factor(movie_ratings$country)
#movie_ratings$language <- as.factor(movie_ratings$language)
#movie_ratings$director <- as.factor(movie_ratings$director)


#movie_ratings<-as.matrix(movie_ratings)
```
