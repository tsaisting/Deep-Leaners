...
hist(movies$avg_vote,col='blue2',border='pink',main="Rating distribution",xlab='Rating')
...
ggplot(years_num,aes(x=reorder(Year,Movie_numbers),y=Movie_numbers))+geom_col(stat='identity',fill='#f68060',alpha=.6, width=.4)+labs(title=(' Movie_numbers - Year'))+coord_flip()+xlab('Year')+theme(axis.text.x = element_text(size=10),axis.text.y = element_text(size = 4))
...
ggplot(data=years_rating,aes(x=reorder(Year,Rating),y=Rating)) +geom_col(stat='identify',width=0.9,fill='lightblue',binwidth=25)+coord_flip()+xlab('Year')+ylab('Mean of Rating')+labs(title=( 'Mean of Rating - Year'))+theme(axis.text.x = element_text(size=10),axis.text.y = element_text(size = 4))
...
ggplot(data=years_vote,aes(x=reorder(Year,Votes),y=Votes)) +geom_col(fill='purple4',alpha=1, width=2)+xlab('Year')+ylab('Sum of Votes')+coord_flip()+labs(title=('Sum of Votes - Year'))+theme(axis.text.x = element_text(size=10),axis.text.y = element_text(size = 4))
...
ggplot(data=years_duration,aes(x=reorder(Year,Duration),y=Duration)) +geom_col(fill='pink',alpha=1, width=2)+xlab('Year')+ylab('Duration')+coord_flip()+labs(title=('Movie Duration - Year'))+theme(axis.text.x = element_text(size=10),axis.text.y = element_text(size = 4))
...
ggplot(data=duration_rating,,mapping=aes(x=Duration,y=Rating)) +geom_col(fill='red2',alpha=.6)+labs(title=('Movie duration and Rating distribution'))+theme(axis.text.x = element_text(size=10),axis.text.y = element_text(size = 10))
