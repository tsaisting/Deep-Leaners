...
model.final <- lm(complete_formula, data = movie_ratings_final3)
summary(model.final)
...
quantile(movie_ratings_final3$avg_vote, probs = c(.2, .4, .6, .8))

movie_ratings_final3$avg_vote[which(movie_ratings_final3$avg_vote <=(quantile(movie_ratings_final3$avg_vote, probs = 0.2)))] = 0
movie_ratings_final3$avg_vote[which(movie_ratings_final3$avg_vote >(quantile(movie_ratings_final3$avg_vote, probs = 0.2)) & movie_ratings_final3$avg_vote <=(quantile(movie_ratings_final3$avg_vote, probs = 0.4)) )] = 1
movie_ratings_final3$avg_vote[which(movie_ratings_final3$avg_vote >(quantile(movie_ratings_final3$avg_vote, probs = 0.4)) & movie_ratings_final3$avg_vote <=(quantile(movie_ratings_final3$avg_vote, probs = 0.6)) )] = 2
movie_ratings_final3$avg_vote[which(movie_ratings_final3$avg_vote >(quantile(movie_ratings_final3$avg_vote, probs = 0.6)) & movie_ratings_final3$avg_vote <=(quantile(movie_ratings_final3$avg_vote, probs = 0.8)) )] = 3
movie_ratings_final3$avg_vote[which(movie_ratings_final3$avg_vote >(quantile(movie_ratings_final3$avg_vote, probs = 0.8)))] = 4

movie_ratings_final3$avg_vote <- as.factor(movie_ratings_final3$avg_vote)
```
