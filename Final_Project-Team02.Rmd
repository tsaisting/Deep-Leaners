...
For this project, our smart questions were to predict movie ratings with linear model and recommend good movies with logistic model. Therefore, we chose the linear regression model for the first question and the logistic regression model for the second question. After finishing the linear regression model, we gained feature importance by building a decision regression tree model.
