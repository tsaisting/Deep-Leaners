...
## Avg_vote split
quantile(movie_ratings_final3$avg_vote, probs = 0.5)
...
Compute 95% confidence interval for coefficients in logistic model.
...
ratingLogitHoslem = hoslem.test(data_train$avg_vote, fitted(model_1)) # Hosmer and Lemeshow test, a chi-squared test
