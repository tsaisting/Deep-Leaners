...
quantile(model_data$avg_vote, probs = c(.2, .4, .6, .8))

<<<<<<< Updated upstream
model_data$avg_vote[which(model_data$avg_vote <=(quantile(model_data$avg_vote, probs = 0.2)))] = 0
model_data$avg_vote[which(model_data$avg_vote >(quantile(model_data$avg_vote, probs = 0.2)) & model_data$avg_vote <=(quantile(model_data$avg_vote, probs = 0.4)) )] = 1
model_data$avg_vote[which(model_data$avg_vote >(quantile(model_data$avg_vote, probs = 0.4)) & model_data$avg_vote <=(quantile(model_data$avg_vote, probs = 0.6)) )] = 2
model_data$avg_vote[which(model_data$avg_vote >(quantile(model_data$avg_vote, probs = 0.6)) & model_data$avg_vote <=(quantile(model_data$avg_vote, probs = 0.8)) )] = 3
model_data$avg_vote[which(model_data$avg_vote >(quantile(model_data$avg_vote, probs = 0.8)))] = 4
